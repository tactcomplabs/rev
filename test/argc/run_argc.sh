...
if [[ -x argc.exe ]]; then
	...
	sst --add-lib-path="$BUILDDIR"/src/ ../rev-mordred.py -- --program "argc.exe" --args "one two three" --enableMemH=0
	...
	sst --add-lib-path="$BUILDDIR"/src/ ../rev-mordred.py -- --program "argc.exe" --args "one two three" --enableMemH=1
