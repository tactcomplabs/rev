...
int main() {
    ...
    if (pid == 0) { // This is the child process
      const char msg[6] = "CHILD";// {72, 69, 0};
      size_t msg_len = 6; // Length of the message string, including the newline character
      ...
      const char parent_msg[7] = "PARENT";// {72, 69, 0};
      size_t parent_msg_len = 7; // Length of the message string, including the newline character
