...
int main() {
  ...
  // The test below fails - we are reaching into invalid address space, this
  // appears unrealted to most recent changes
  /*  const char msg3[98] = "Greetings - this is a much longer message and some
    nice text, in fact, it is bigger than 64 bytes\n"; ssize_t bytes_written3 =
