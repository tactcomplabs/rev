...
int main( int argc, char **argv ) {
  ...
  FCVT_TEST(
    29, int64_t, float, fcvt.l.s, 0x7fffff8000000000, 0x1.fffffep+62f, rtz );
  // FCVT_TEST(        30,   int64_t,     float,   fcvt.l.s,           INT64_MAX,  0x1.ffffffp+62f,  rtz  );
  FCVT_TEST(
    31, int64_t, float, fcvt.l.s, 0x8000010000000000, -0x1.fffffdp+62f, rtz );
  FCVT_TEST(
    32, int64_t, float, fcvt.l.s, 0x8000008000000000, -0x1.fffffep+62f, rtz );
  ...
  FCVT_TEST(
    41, uint64_t, float, fcvt.lu.s, 0xffffff0000000000, 0x1.fffffep+63f, rtz );
  ...
  FCVT_TEST(
    52, int32_t, double, fcvt.w.d, 2147483647, 0x1.fffffffffffffp+30, rtz );
  FCVT_TEST( 53, int32_t, double, fcvt.w.d, INT32_MAX, 0x1.0p+31, rtz );
  FCVT_TEST(
    54, int32_t, double, fcvt.w.d, -2147483647, -0x1.fffffffffffffp+30, rtz );
  ...
  FCVT_TEST(
    65, uint32_t, double, fcvt.wu.d, UINT32_MAX, 0x1.fffffffffffffp+31, rtz );
