...
int main( int argc, char** argv ) {
  ...
  TEST_CASE( 10, x5, 0x0000000000ff00ff, ASM_GEN( la x6, tdat ); ASM_GEN( addi x6, x6, -32 ); ASM_GEN( lw x5, 32( x6 ) ); )

  //# Test with unaligned base

  TEST_CASE( 11, x5, 0xffffffffff00ff00, ASM_GEN( la x6, tdat ); ASM_GEN( addi x6, x6, -3 ); ASM_GEN( lw x5, 7( x6 ) ); )
