...
using GetgidSystemCallParametersInterfaceType = SystemCallInterface<RiscvArchType, 172>;
...
template<typename RiscvArchType=Riscv32>
using GetgidSystemCallInterfaceType = SystemCallInterface<RiscvArchType, 172>;
