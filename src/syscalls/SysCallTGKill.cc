...
template<>
bool Tgkill<RiscvArchType>::get(const size_t parameter_index, int& param) {
...
template<typename RiscvArchType>
template<>
void Tgkill<RiscvArchType>::invoke<int>(Tgkill<RiscvArchType>::SystemCallParameterInterfaceType & parameters, int & value) {
