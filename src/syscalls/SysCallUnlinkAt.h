...
using UnlinkatParametersInterfaceType = SystemCallInterface<RiscvArchType, 35>;

template<typename RiscvArchType=Riscv32>
class UnlinkatParameters : public virtual UnlinkatParametersInterfaceType<RiscvArchType> {
