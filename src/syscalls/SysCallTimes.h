...
using TimesSystemCallParametersInterfaceType = SystemCallInterface<RiscvArchType, 93>;
...
template<typename RiscvArchType=Riscv32>
using TimesSystemCallInterfaceType = SystemCallInterface<RiscvArchType, 93>;
