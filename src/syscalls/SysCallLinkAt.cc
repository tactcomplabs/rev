...
template<>
bool Linkat<RiscvArchType>::get(const size_t parameter_index, std::string& param) {
...
template<typename RiscvArchType>
template<>
bool Linkat<RiscvArchType>::get(const size_t parameter_index, int& param) {
...
template<typename RiscvArchType>
template<>
void Linkat<RiscvArchType>::invoke<int>(Linkat<RiscvArchType>::SystemCallParameterInterfaceType & parameters, int & value) {
