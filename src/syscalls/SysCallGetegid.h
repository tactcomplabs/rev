...
using GetegidSystemCallParametersInterfaceType = SystemCallInterface<RiscvArchType, 172>;
...
template<typename RiscvArchType=Riscv32>
using GetegidSystemCallInterfaceType = SystemCallInterface<RiscvArchType, 172>;
