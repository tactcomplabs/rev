...
using GettidSystemCallParametersInterfaceType = SystemCallInterface<RiscvArchType, 172>;
...
template<typename RiscvArchType=Riscv32>
using GettidSystemCallInterfaceType = SystemCallInterface<RiscvArchType, 172>;
