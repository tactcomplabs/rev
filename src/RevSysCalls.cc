...
// TODO: // 5, rev_setxattr(const char  *path, const char  *name, const void  *value, size_t size, int flags) 
// RevProc::ECALL_status_t RevProc::ECALL_setxattr(RevInst& inst){
//   output->verbose(CALL_INFO, 2, 0, "ECALL: setxattr called by thread %i\n", GetActiveThreadID());
...
// TODO: 17, rev_getcwd(char  *buf, unsigned long size) 
...
// TODO: RevProc::ECALL_status_t RevProc::ECALL_chdir(RevInst& inst){
...
// TODO: RevProc::ECALL_status_t RevProc::ECALL_close(RevInst& inst){
...
// TODO: 63, rev_read(unsigned int fd, char  *buf, size_t count) 
...
//   if( !CurrThread->FindFD(fd) ){
//     output->fatal(CALL_INFO, -1,
//                   "Core %d; Hart %d; ThreadID %" PRIu32 " tried to read from file descriptor: %i but did not have access to it\n",
//                   id, HartToExec, GetActiveThreadID(), fd);
//     return RevProc::ECALL_status_t::SUCCESS;
//   }
//   /*
...
// TODO: 64, rev_write(unsigned int fd, const char  *buf, size_t count) 
...
// TODO: 215, rev_munmap(unsigned long addr, size_t len) 
...
// TODO: Move RevProc::ECALL_status_t RevProc::ECALL_mmap(RevInst& inst){
...
RevProc::ECALL_status_t RevProc::ECALL_getpid(RevInst& inst){
  // TODO: Implement error handling
  output->verbose(CALL_INFO, 2, 0, "ECALL_getpid called (Rev only supports a single process)\n");
  return ECALL_status_t::SUCCESS;
}
...
RevProc::ECALL_status_t RevProc::ECALL_getppid(RevInst& inst){
  // TODO: Implement error handling
  output->verbose(CALL_INFO, 2, 0, "ECALL_getppid called (Rev only supports a single process)\n");
  return ECALL_status_t::SUCCESS;
}
...
/* rev_gettid(void) */
/* ================ */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_gettid(RevInst& inst){
...
/* ========================================================= */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_settimeofday(RevInst& inst){
...
/* ============================================================= */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_gettimeofday(RevInst& inst){
...
/* size_t sigsetsize) */
/* ========================================================================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_rt_sigprocmask(RevInst& inst){
...
/* ================================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_timer_delete(RevInst& inst){
...
/* ===========================================================================*/
// TODO: RevProc::ECALL_status_t RevProc::ECALL_timer_create(RevInst& inst){
...
/* ========================================================================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_nanosleep(RevInst& inst){
...
/*   size_t *len_ptr) */
/* ========================================================================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_get_robust_list(RevInst& inst){
...
/* ============================================================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_set_robust_list(RevInst& inst){
...
/*   struct rusage  *ru) */
/* ==========================================================================*/
// TODO: RevProc::ECALL_status_t RevProc::ECALL_waitid(RevInst& inst){
...
/* ============================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_exit_group(RevInst& inst){
...
/* ============================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_fdatasync(RevInst& inst){
...
/* ========================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_fsync(RevInst& inst){
...
/* rev_sync(void) */
/* ============== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_sync(RevInst& inst){
...
/* =================================================================== */
// TODO: RevProc::ECALL_status_t RevProc::ECALL_tee(RevInst& inst){
