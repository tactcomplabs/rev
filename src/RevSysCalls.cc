...
EcallStatus RevCore::EcallLoadAndParseString( uint64_t                straddr,
                                              std::function< void() > action ) {
  auto  rtval      = EcallStatus::ERROR;
  auto& EcallState = Harts.at( HartToExecID )->GetEcallState();

  if( RegFile->GetLSQueue()->count(
        LSQHash( RevReg::a0, RevRegClass::RegGPR, HartToExecID ) ) > 0 ) {
    ...
    if( EcallState.bytesRead != 0 ) {
      EcallState.string +=
        std::string_view( EcallState.buf.data(), EcallState.bytesRead );
    ...
    if( EcallState.string.size() && !EcallState.string.back() ) {
      ...
      MemReq req{ straddr + EcallState.string.size(),
                  RevReg::a0,
                  RevRegClass::RegGPR,
                  HartToExecID,
                  MemOp::MemOpREAD,
...
EcallStatus RevCore::ECALL_dup() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: dup called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_dup3() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: dup3 called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_ioctl() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: ioctl called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_flock() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: flock called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_linkat() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: linkat called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_umount() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: umount called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_mount() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: mount called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_chroot() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: chroot called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_fchmod() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: fchmod called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_fchown() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: fchown called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_close() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: close called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
...
EcallStatus RevCore::ECALL_pipe2() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: pipe2 called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_lseek() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: lseek called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_read() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: read called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  auto  fd           = RegFile->GetX< int >( RevReg::a0 );
...
EcallStatus RevCore::ECALL_write() {
  ...
  if( LSQueue->count( lsq_hash ) == 0 ) {
    MemReq req( addr + EcallState.string.size(),
                RevReg::a0,
                RevRegClass::RegGPR,
                HartToExecID,
                MemOp::MemOpREAD,
...
EcallStatus RevCore::ECALL_readv() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: readv called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_writev() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: writev called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_preadv() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: preadv called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_splice() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: splice called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_tee() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: tee called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_sync() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: sync called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_fsync() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: fsync called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_acct() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: acct called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_capget() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: capget called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_capset() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: capset called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_exit() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: exit called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
...
EcallStatus RevCore::ECALL_waitid() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: waitid called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_futex() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: futex called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_clock_gettime() {
  output->verbose( CALL_INFO,
                   ...
                   HartToExecID );
  struct timespec src,
    *tp = (struct timespec*) RegFile->GetX< uint64_t >( RevReg::a1 );
...
EcallStatus RevCore::ECALL_syslog() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: syslog called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_ptrace() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: ptrace called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_kill() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: kill called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_tkill() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: tkill called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_tgkill() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: tgkill called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_reboot() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: reboot called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_setgid() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: setgid called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_setuid() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: setuid called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_times() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: times called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_getsid() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: getsid called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_setsid() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: setsid called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_umask() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: umask called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_prctl() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: prctl called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_getcpu() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: getcpu called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_getgid() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: getgid called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_gettid() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: gettid called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
...
EcallStatus RevCore::ECALL_msgget() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: msgget called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_msgctl() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: msgctl called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_msgrcv() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: msgrcv called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_msgsnd() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: msgsnd called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_semget() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: semget called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_semctl() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: semctl called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_semop() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: semop called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_shmget() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: shmget called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_shmctl() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: shmctl called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_shmat() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: shmat called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_shmdt() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: shmdt called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_socket() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: socket called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_bind() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: bind called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_listen() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: listen called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_accept() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: accept called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_sendto() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: sendto called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_munmap() {
  ...
  if( rc == -1 ) {
    output->fatal( CALL_INFO,
                   11,
                   "Failed to perform munmap(Addr = 0x%" PRIx64
                   ", Size = %" PRIu64 ")"
...
EcallStatus RevCore::ECALL_mremap() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: mremap called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_keyctl() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: keyctl called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_clone() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: clone called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
...
EcallStatus RevCore::ECALL_execve() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: execve called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_swapon() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: swapon called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_msync() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: msync called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_mlock() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: mlock called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_mbind() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: mbind called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_wait4() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: wait4 called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_syncfs() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: syncfs called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_setns() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: setns called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_kcmp() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: kcmp called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_bpf() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: bpf called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_mlock2() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: mlock2 called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_statx() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: statx called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_rseq() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: rseq called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_fsopen() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: fsopen called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_fspick() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: fspick called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  return EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_clone3() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: clone3 called by thread %" PRIu32 " on hart %" PRIu32
                   "\n",
                   ActiveThreadID,
                   HartToExecID );
  auto rtval = EcallStatus::SUCCESS;
...
EcallStatus RevCore::ECALL_perf_stats() {
  output->verbose( CALL_INFO,
                   2,
                   0,
                   "ECALL: perf_stats called by thread %" PRIu32 "\n",
                   GetActiveThreadID() );
  rev_stats rs,
    *dest =
      reinterpret_cast< rev_stats* >( RegFile->GetX< uint64_t >( RevReg::a0 ) );
...
EcallStatus RevCore::ECALL_pthread_create() {
  ...
  mem->WriteMem(
    HartToExecID, tidAddr, sizeof( NewTID ), &NewTID, RevFlag::F_NONE );
  return EcallStatus::SUCCESS;
}
...
EcallStatus RevCore::ECALL_pthread_join() {
  ...
  if( HartHasNoDependencies( HartToExecID ) ) {
    ...
    std::unique_ptr< RevThread > BlockedThread =
      PopThreadFromHart( HartToExecID );
    BlockedThread->SetState( ThreadState::BLOCKED );
    BlockedThread->SetWaitingToJoinTID(
      RegFile->GetX< uint64_t >( RevReg::a0 ) );
...
EcallStatus RevCore::ECALL_dump_mem_range_to_file() {
  ...
  if( EcallState.bytesRead == 0 ) {
    output->verbose( CALL_INFO,
                     2,
                     0,
                     "ECALL: dump_mem_range called by thread %" PRIu32
                     " on hart %" PRIu32 "\n",
                     ActiveThreadID,
                     HartToExecID );
  }
...
EcallStatus RevCore::ECALL_dump_stack_to_file() {
  ...
  if( EcallState.bytesRead == 0 ) {
    output->verbose( CALL_INFO,
                     2,
                     0,
                     "ECALL: dump_stack_to_file called by thread %" PRIu32
                     " on hart %" PRIu32 "\n",
                     ActiveThreadID,
                     HartToExecID );
  }
...
EcallStatus RevCore::ECALL_dump_thread_mem() {
  ...
  if( EcallState.bytesRead == 0 ) {
    output->verbose( CALL_INFO,
                     2,
                     0,
                     "ECALL: dump_thread_mem called by thread %" PRIu32
                     " on hart %" PRIu32 "\n",
                     ActiveThreadID,
                     HartToExecID );
  }
...
EcallStatus RevCore::ECALL_dump_thread_mem_to_file() {
  ...
  if( EcallState.bytesRead == 0 ) {
    output->verbose( CALL_INFO,
                     2,
                     0,
                     "ECALL: dump_thread_mem_to_file called by thread %" PRIu32
                     " on hart %" PRIu32 "\n",
                     ActiveThreadID,
                     HartToExecID );
  }
