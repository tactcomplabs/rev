...
Match SST output with asm file and/or print call stack at a specified clock
tick - use with TRACER_ON in target program.
Use 'riscv64-unknown-elf-objdump -dC -Mno-aliases <exe>' to create assembly file
""")
