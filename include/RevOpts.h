...
private:
  ...
  std::map< unsigned, uint64_t >
    startAddr;  ///< RevOpts: map of core id to starting address
  std::map< unsigned, std::string >
    startSym;  ///< RevOpts: map of core id to starting symbol
  std::map< unsigned, std::string >
    machine;  ///< RevOpts: map of core id to machine model
  std::map< unsigned, std::string >
    table;  ///< RevOpts: map of core id to inst table
  std::map< unsigned, unsigned >
    prefetchDepth;  ///< RevOpts: map of core id to prefretch depth
